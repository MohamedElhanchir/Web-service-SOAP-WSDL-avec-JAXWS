...
public class ObjectFactory {
    ...
    private static final QName _ConversionEuroToDh_QNAME = new QName("http://ws.mohamed.elhanchir/", "ConversionEuroToDh");
    private static final QName _ConversionEuroToDhResponse_QNAME = new QName("http://ws.mohamed.elhanchir/", "ConversionEuroToDhResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.mohamed.elhanchir/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.mohamed.elhanchir/", "getCompteResponse");
    private static final QName _GetComptes_QNAME = new QName("http://ws.mohamed.elhanchir/", "getComptes");
    private static final QName _GetComptesResponse_QNAME = new QName("http://ws.mohamed.elhanchir/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "ConversionEuroToDh")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "ConversionEuroToDhResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.mohamed.elhanchir/", name = "getComptesResponse")
