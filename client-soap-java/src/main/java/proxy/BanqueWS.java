 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.mohamed.elhanchir/", wsdlLocation = "http://localhost:9098/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.mohamed.elhanchir/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9098/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.mohamed.elhanchir/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mohamed.elhanchir/", "BanqueServicePort"), BanqueService.class, features);
    }
